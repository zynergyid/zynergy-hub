...
export async function GET(req: NextRequest) {
  ...
  await logActivity(await getPayloadClient(), { action: "export", collection: "export", title: "Laporan keuangan ringkas", summary: req.nextUrl.search ? req.nextUrl.search.slice(1).replace(/&/g, " · ") : null, actor: { id: user.id, name: user.name } });
